    ...
    public void onReceivedData(byte[] arg0) {
      ...
      try {
        ...
        if (arg0.length == 1 && arg0[0] == 3) {
          ...
          if (ActivityCompat.checkSelfPermission(AlertSettings.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
            ...
            AlertSettings.this.startActivity(intent);
          }
        }
      } catch (Exception e) {
